...
<div class="page-header" style="margin-top: -5px; margin-left: 20px; margin-bottom: -10px">
		...
		<section class="content">
				<form:form method="POST" name="form"
					action="${pageContext.request.contextPath}/feature/insertfeature"
					modelAttribute="featureInsertCommand">
					<div class="box box-default">

						<div class="box-header with-border">
							<h3 class="box-title">Insert Feature</h3>
						</div>
						<!-- /.box-header -->
						<div class="box-body">
							...
							<div class="form-group row" style="margin-left: 215px">
								<div class="col-sm-8">
									<button
										style="" type="submit"
										name="submit" class="btn btn-primary">Insert Feature</button>
								</div>
							</div>
						</div>
						<!-- /.box-body -->
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
					...
					<div class="example1">
						<span class="col-sm-12 from-control-label"
							...
							<c:if test="${not empty featureId }">
							Successfully Insert Feature And Your Feature Id : ${featureId }
 							</c:if>
						</span>
					</div>
				</div>
