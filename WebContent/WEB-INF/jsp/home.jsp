...
<th><a href="#" ><span>Current_Price</span></a></th>
											...
											ng-click="sortType = 'CLOSE_PRICE'; sortReverse = !sortReverse">
												${dailyHighLight.close_price} <span
												ng-show="sortType == 'CLOSE_PRICE' && !sortReverse"
												class="fa fa-caret-down">${dailyHighLight.close_price}</span>
												<span
												ng-show="sortType == 'CLOSE_PRICE' && sortReverse"
										...
										<div class="tab-pane fade" id="buy">
											<div class="table-responsive clearfix">
												...
												<table class="table table-hover">
													...
													<td><a href="#"
											ng-click="sortType = 'CLOSE_PRICE'; sortReverse = !sortReverse">
												${buyList.close_price} <span
												ng-show="sortType == 'CLOSE_PRICE' && !sortReverse"
												class="fa fa-caret-down">${buyList.close_price}</span>
												<span
												ng-show="sortType == 'CLOSE_PRICE' && sortReverse"
												class="fa fa-caret-up"></span>
