							...
							<div class="box">
								...
								<div class="box-body">
									...
									<div class="panel panel-default col-sm-12 col-md-12">
										...
										<div class="col-sm-12 col-md-12" >
											<table id="example1"
												...
												<tr>
													<td><input type="radio" name="choose" id="mvradio" checked
														value="average" ng-init="MovingAvarage()"/><!-- ng-click="MovingAvarage();" --> <label
														style="padding-left: 10px" class="control-label">MOVING
															AVG:</label></td>
													<th ng-repeat="option in optionss"><input
														onclick="javascript:if (this.checked){document.getElementById('mvradio').checked =true;}"
															ng-click="passCompanyName(-2)"
												...
												<tr>
													...
													<td colspan="4"><input type="checkbox"
														onclick="javascript:if (this.checked){document.getElementById('cmpny').checked = true;}"
									...
									<%-- <div class="panel panel-default col-sm-12 col-md-12">
										...
										<div class="col-sm-12 col-md-12" ng-controller="GraphController" ng-init="MovingAvarage()">
											<table id="example1"
												class="table table-bordered table-hover table-responsive">
												<tr>
													<td><input type="radio" name="choose" id="mvradio"
														value="avarage" ng-click="MovingAvarage();" checked="checked"/><label
														style="padding-left: 10px" class="control-label">MOVING
															AVG:</label></td>
