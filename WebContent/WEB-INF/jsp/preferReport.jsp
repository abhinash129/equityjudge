				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<div class="col-md-9">
								<h3 class="box-title"
									style="font-weight: bolder; margin-left: 14cm;">Latest
									Algorithmic Prediction</h3>
								<br /> <br /> <span
									style="color: red; font-size: large; font-weight: bolder;">&#8667;
									Short term Investor &#47; Traders can make judicious use of
									these <span class="blink_me"
									style="color: green; font-weight: bold;">ALGORITHMIC
										SUGGESTION</span>
								</span> <br /> <span
									style="color: red; font-size: large; font-weight: bolder;">&#8667;
									Trade &#47; Investment should be in high volume shares to get <span
									class="blink_me" style="color: green; font-weight: bold;">Better
										result</span>
								</span>
							...
							onclick="window.location.href='<c:url value="/graphpattern/latestpattern"/>'">
											<span>
											Full List
									</span></button>
							</div>
						...
						<div class="box-body">
							<table id="example2" class="table table-bordered table-hover">
								...
								<tbody>
									...
									<tr
										ng-repeat="roll in latestReportData | orderBy:sortType:sortReverse | filter:searchCompany"
										data-ng-if="(roll.SUGGESTION == 'BUY') && (roll.VALUE >= 3000000)">
										<!-- <td>{{ roll.Sr_No }}</td> -->
										<td><a
											href="${pageContext.request.contextPath}/graphpattern/graph/selectCompny?companyName={{ roll.COMPANYNAME }}"><font
												color="black">{{ roll.COMPANYNAME }}</font></a></td>
						...
						<div class="box-header">
							<div class="col-md-9">
								...
								<br /> <br /> <span
									...
									style="color: red; font-size: large; font-weight: bolder;">&#8667;
									Trade &#47; Investment should be in high volume shares to get <span
									class="blink_me" style="color: green; font-weight: bold;">Better1
										result</span>
								</span>
