								...
								<div style="margin-left: 70px">
									...
									<div class='form-group' style="margin-top: -20px">
										...
										<div class='row col-sm-9 col-md-6'>
											...
											<div class='col-sm-4 col-md-4' style="width: 200px;">
												<div class='form-group'>
													<select id="code"
														style="width: 200px; font-family: monospace; height: 30px;"
														name="code">
														<option value="" disabled selected>Select Country</option>
														<option value="91"
															style="color: orange; font-weight: 900;">INDIA</option>
														...
														<option value="84">Vietnams</option>
													</select>

													<span style="font-size: small; color: rgb(); font-weight: bold;">County Code</span>
											...
											<div class='col-sm-7 col-md-7' style="width: 250px;">
												<div class='form-group'>
													<form:input path="phoneNo" id="phone_number"
														class="form-control" ng-required="true"
														ng-init="phoneNo='${signupCommand.phoneNo}'"
														ng-model="phoneNo" ng-minlength="10" ng-maxlength="17"
														ng-pattern="/^[0-9]{10,16}$/"
											...
											<div style="margin-top: -20px; margin-bottom: -30px"
												...
												<div class="form-group"
													...
													<span style="color: red"
														...
														style="color: red"
														ng-show="form.phoneNo.$error.maxlength "
														class="help-block">Length less than 16</span>
													</span>
												</div>
											</div>
										...
										<div class='row col-sm-11 col-md-10'
											...
											<div class='col-sm-12 col-md-7' style="margin-top: 10px">
												...
												<span style="color: red"
													...
													class="help-block">Length less than 30</span> <span
													style="color: red"
													ng-show="form.userName.$error.minlength "
													class="help-block">Length more than 5</span> <span
													style="color: red;"
												...
												<div class="col-sm-12 col-md-12"
													...
													<div class="form-group"
														...
														<span style="color: red;"
															...
															class="help-block">Confirm password does not
															match.</span>
													</div>
												</div>
											</div>
									...
									<div class='form-group'>
										<div class='row col-sm-3 col-md-3'>
											<button class='btn btn-primary' ng-disabled="form.$invalid"
												type='submit' onclick="return validate()">Register</button>
										</div>
									</div>
								</div>
							</form:form>
