                 		...
                 		<div class="col-md-4">
                 			<div class="form-group">
                 				<select class="form-control select1">
				                     <option selected="selected">Starts With</option>
              			...
              			<div class="col-md-4">
                 			<div class="form-group">
                 				<input type="text" class="form-control" id="inputSuccess" placeholder="Enter Module Id" />
                  			</div>
               			</div>              	  		
              	  </div>
              	  <div class="col-md-6">
                 		...
                 		<div class="col-md-4">
              			...
              			<div class="col-md-4">
                 			<div class="form-group">
                 				<input type="text" class="form-control" id="inputSuccess" placeholder="Enter Module Name" />
                  			</div>
               			</div>              	  		
